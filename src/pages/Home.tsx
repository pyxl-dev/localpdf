...
const tools: { path: string; titleKey: TranslationKey; descKey: TranslationKey; icon: ReactNode }[] = [
  ...
  {
    path: '/reorder',
    titleKey: 'tool.reorder.title',
    descKey: 'tool.reorder.desc',
    icon: (
      <svg fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5} className="h-8 w-8">
  ...
  {
    path: '/remove',
    titleKey: 'tool.remove.title',
    descKey: 'tool.remove.desc',
    icon: (
      <svg fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5} className="h-8 w-8">
  ...
  {
    path: '/images-to-pdf',
    titleKey: 'tool.images.title',
    descKey: 'tool.images.desc',
    icon: (
      <svg fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5} className="h-8 w-8">
  ...
  {
    path: '/page-numbers',
    titleKey: 'tool.pagenumbers.title',
  ...
  {
    path: '/html-to-pdf',
    titleKey: 'tool.html.title',
    descKey: 'tool.html.desc',
    icon: (
      <svg fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5} className="h-8 w-8">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 max-w-4xl mx-auto">
        {tools.map((tool) => (
          ...
          >
            ...
            <h3 className="text-white font-semibold mb-1.5">{t(tool.titleKey)}</h3>
            <p className="text-slate-400 text-sm leading-relaxed">{t(tool.descKey)}</p>
          </Link>
        ))}
      </div>
